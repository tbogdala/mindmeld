...
cmake -B build-windows -DGGML_CUDA=On -DGGML_FMA=Off -DGGML_AVX512=Off -DGGML_AVX512_VBMI=Off -DGGML_AVX512_VNNI=Off -DGGML_AVX512_BF16=Off -DCMAKE_WINDOWS_EXPORT_ALL_SYMBOLS=TRUE -DBUILD_SHARED_LIBS=Off -DWOOLY_TESTS=Off woolycore
...
# The app itself can now be build with a command like this
#
